...
<div class="features_items"><!--features_items-->
                        <h2 style="margin-top: 10px;" class="title text-center">{{$th_ten->th_Ten}}</h2>
                        <div class="row">
                            <div class="col-lg-4">
                                @php
                                    $category_id = [];
                                ...
                                @foreach($loai_sp_th as $key => $loaisanpham)
                                    @php
                                        $i =0;
                                        $test = 0;
                                        
                                        if($key == 0){
                                            $data[0] = $loaisanpham->l_id; 

                                       }else{
                                        while ($i < $key ) {
                                            if($data[$i] == $loaisanpham->l_id){
                                                $test = 1;
                                                break;
                                            }else{
                                                $i++;
                        ...
                        <br>
                        @foreach($th_sp_id as $key => $sanpham )
