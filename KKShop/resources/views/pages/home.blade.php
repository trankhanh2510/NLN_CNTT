...
<div class="features_items"><!--features_items-->
                        <h2 class="title text-center" style="margin-top: 10px;">Sản phẩm</h2>
                        <div class="row">
                            <div class="col-lg-3">
                            @php
                                $category_id = [];
                            ...
                            @endphp
                                <label for="amount" style="color: blue;font-size: 18px;">Danh mục</label><br>
                            @foreach($loai_sp as $key => $loaisanpham)
                                 <label class="checkbox-inline">
                                    <input type="checkbox" 
                                    {{in_array($loaisanpham->l_id,$category_arr) ? 'checked' : '' }}
                                    class="form-control-checkbox panel-title category-filter" data-filters="category" value="{{$loaisanpham->l_id}}" naem="category-filter">{{$loaisanpham->Ten}}
                                </label>
                            @endforeach
                            ...
                            @foreach($thuonghieu_sp as $key => $thuonghieusanpham)
                                <label class="checkbox-inline">
                                    <input type="checkbox" 
                                    {{in_array($thuonghieusanpham->th_id,$brand_arr) ? 'checked' : '' }}
                                    class="form-control-checkbox panel-title brand-filter" data-filters="brand" value="{{$thuonghieusanpham->th_id}}" naem="brand-filter">{{$thuonghieusanpham->th_Ten}}
                                </label>
                            @endforeach
                               
                            </div>
                            <div class="col-lg-2">
                                <label for="amount" style="color: blue;font-size: 18px;">Sắp xếp</label>
                                <form>
                                     @csrf
